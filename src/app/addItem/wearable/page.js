...
import facultyData from '@/app/data/faculty.json';
...
export default function SellProductClothing() {
  ...
  const selectCondition = (condition) => {
    setProductData(prev => ({
      ...prev,
      selectedCondition: condition === prev.selectedCondition ? null : condition
    }))
  }
  ...
  return (
    ...
    {/*Upload Section */}
        <div className="bg-white p-4 rounded-lg shadow-md w-full max-w-lg mb-1 text-center mt-20">
          ...
          <div className="flex justify-center items-center bg-gray-200 rounded w-full md:w-full lg:w-full h-80 mb-4">
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        {/* Product Name Section */}
            <section>
                ...
                <Field>
                    <Label className="block text-sm font-medium mb-1">เหมาะสำหรับคณะ</Label>
                    <Select name="status" className="border-solid border outline-black rounded-md focus:outline-black" aria-label="Project status">
        ...
        <section>
          <h2 className="text-lg font-medium border-b pb-2 mb-4">รายละเอียดสินค้า</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium mb-1">ขนาดตามป้าย</label>
              <input
                type="text"
                name="standardSize"
            ...
            <div>
              <label className="block text-sm font-medium mb-1">ขนาดแบบละเอียด</label>
              <input
                type="text"
                name="detailedSize"
          ...
          <div className="mt-3">
            <label className="block text-sm font-medium mb-1">ยี่ห้อและรุ่น</label>
            <input
              type="text"
              name="brandAndModel"
          ...
          <div className="mt-3">
            <label className="block text-sm font-medium mb-1">วิธีที่ใช้และข้อมูลเกี่ยวกับการดูแลรักษา</label>
            <textarea
        ...
        <section>
          <h2 className="text-lg font-medium border-b pb-2 mb-4">สภาพสินค้า</h2>
              ...
              >
                ...
                <label htmlFor={condition} className="ml-2 text-gray-700">
                  ...
                  {descriptions[condition] && 
                    <div className="text-xs text-gray-500 mt-1">{descriptions[condition]}</div>
                  }
                </label>
              </div>
            ))}
          ...
          <div className="mt-4">
            <label className="block text-sm font-medium mb-1">รายละเอียดสภาพสินค้า (ถ้ามี ควรกรอกเพิ่มเติม)</label>
            <textarea
        ...
        {/* Shipping Section */}
        <section>
          <h2 className="text-lg font-medium border-b pb-2 mb-4">การจัดส่งสินค้า</h2>
          
          <div className="flex items-center mb-2">
            <span className="block text-sm font-medium">วิธีการจัดส่ง</span>
            <span className="ml-2 text-xs text-gray-500">(เช่น Kerry, Flash, ไปรษณีย์ ให้ระบุรายละเอียด)</span>
          </div>
          ...
          <div className="mt-4">
            <label className="block text-sm font-medium mb-1">ค่าจัดส่งในการจัดส่ง</label>
            <input
              type="number"
              name="shippingCost"
              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
        ...
        <div className="pt-4 w-full">
          <button
            type="submit"
            className="px-6 py-3 bg-customPink text-white rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 w-full"
          >
            บันทึกข้อมูลสินค้า
          </button>
        </div>
